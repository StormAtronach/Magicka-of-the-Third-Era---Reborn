-- modules/known_effects.lua
-- Tracks which magic effects the player has already seen on spells they own.
-- Used by ui.lua to highlight spells with new effects in the spell merchant UI.
